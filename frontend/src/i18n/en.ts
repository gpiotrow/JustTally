...
export const en: Record<TKey, string> = {
  ...
  'detail.settings': 'Machine settings',
  ...
  'workout.draftSaveError': "Couldn't save a local backup — keep this tab open until you tap Save.",
  'workout.set': 'Set',
  'workout.reps': 'Reps',
  'workout.weight': 'Weight',
  'workout.setDuration': 'Duration',
  'workout.setDistance': 'Distance (m)',
  'workout.doneColumn': 'Done',
  'workout.addSet': '+ Set',
  'workout.settings': 'Settings',
  ...
  'history.recordKind.reps': 'reps',
  'history.recordKind.duration': 'duration',
  'history.recordKind.distance': 'distance',
  ...
  'stats.maxReps': 'Most reps',
  'stats.maxDuration': 'Longest duration',
  'stats.maxDistance': 'Longest distance',
  ...
  'stats.repsHistory': 'History: reps',
  'stats.durationHistory': 'History: duration',
  'stats.weightHistory': 'History: weight',
  'stats.distanceHistory': 'History: distance',
  'stats.paceHistory': 'History: pace',
  ...
  'form.trackingHint': 'Which fields are logged during a workout for this exercise.',
  'form.settings': 'Machine settings',
  'form.settingsHint': 'Which settings this machine has — logging a workout will ask for values.',
  ...
  'routines.targetDuration': 'Target duration (sec)',
  'routines.targetDistance': 'Target distance (m)',
  'routines.alternatives': 'Alternatives',
  'routines.addAlternative': '+ Alternative',
  'routines.removeAlternative': 'Remove alternative {name}',
  'routines.removedDay': 'Removed {name}',
  'routines.removedExercise': 'Removed {name}',
  'routines.removedAlternative': 'Removed alternative {name}',
  ...
  'tracking.reps_weight': 'Reps & weight',
  'tracking.reps': 'Reps only',
  'tracking.time': 'Time only',
  'tracking.time_weight': 'Time & weight',
  'tracking.distance_time': 'Distance & time',

  // Machine setting labels
  'setting.seat_height': 'Seat height',
  'setting.seat_depth': 'Seat depth',
  'setting.back_pad': 'Back pad',
  'setting.chest_pad': 'Chest pad',
  'setting.leg_pad': 'Leg pad',
  'setting.thigh_pad': 'Thigh pad',
  'setting.lever_arm': 'Lever arm',
  'setting.range_limiter': 'Range limiter',
  'setting.foot_plate': 'Foot plate',
  'setting.handle_position': 'Handle position',
  'setting.cable_height': 'Cable height',
  'setting.bench_angle': 'Bench angle',
  'setting.safety_pins': 'Safety pins',
  'setting.resistance_level': 'Resistance level',
};
